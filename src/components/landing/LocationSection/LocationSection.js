    ...
    <section className="py-24 px-6" style={{ background: "#fafafa" }}>
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-12">
          ...
          >
            Basats a{" "}
            <span className="gradient-text">Lleida</span>
          </h2>
        </div>
        ...
        <div className="flex flex-col md:flex-row gap-10 items-stretch">
          ...
          <div className="md:w-2/5 flex flex-col gap-5">
            ...
            <div
              ...
              style={{ background: "white", border: "1px solid #f0f0f0", boxShadow: "0 4px 20px rgba(0,0,0,0.05)" }}
            >
              <div
                className="flex-shrink-0 w-12 h-12 rounded-xl flex items-center justify-center"
                style={{ background: "rgba(255,116,48,0.12)" }}
              >
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#FF7430" strokeWidth="2">
                  <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"/>
                  <circle cx="12" cy="10" r="3"/>
                </svg>
              </div>
              <div>
                <div className="font-bold text-base mb-1" style={{ color: "#232323" }}>
                  Escola Politècnica Superior
                </div>
                <div className="text-sm leading-relaxed" style={{ color: "#777" }}>
                  Carrer de Jaume II, 69<br />
            ...
            >
              ...
              <div>
                ...
                <div className="text-sm leading-relaxed" style={{ color: "#777" }}>
                  Associació vinculada a l'EPS · UdL<br />
          ...
          <div className="md:w-3/5 w-full">
            <div
              ...
              style={{ minHeight: "300px", height: "clamp(300px, 50vw, 450px)", border: "1px solid #f0f0f0" }}
            >
              <iframe
