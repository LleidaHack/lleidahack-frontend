  ...
  return (
    <div className="flex flex-col">
      <div className="bg-primaryLanding w-full h-16 px-4 py-2 items-center">
        ...
        <div className="absolute h-[100%] w-screen bg-white z-50 inset-x-0  md:relative  appear-animation mt-2 md:mt-3   md:w-full" id="container-points">
          <div className="flex md:justify-between items-center bg-background-patron h-full w-full md:bg-primaryLanding md:bg-background-none">
            ...
            <div className="absolute md:relative top-0 text-black flex flex-col md:flex-row items-left justify-center w-full gap-y-2 gap-x-10 mt-3 md:mt-0 ml-5 md:ml-0">
              ...
              <li className="text-xl list-none	">
               ...
               <div className="flex mt-10 md:mt-0 hidden md:visible ">
