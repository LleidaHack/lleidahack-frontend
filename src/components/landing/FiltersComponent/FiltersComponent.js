...
const FiltersComponent = ({}) => {
    const{hasCategory, hasDates, hasType, categorySelected, typeSelected, dateSelected} = useSearch(); 
    ...
    <div className="filters-component flex flex-row shadow h-20">
      ...
      <div className={`filter-button basis-1/2 bg-white  border-x`}>
        <div className="filter-button__content flex flex-column py-2 px-4">
          ...
          <div className="2nd_content flex flex-row justify-between">
            <p className="extra mb-0 select-none	">{categorySelected || "Totes les categories"}</p>
            <div className="align-middle self-center h-auto">
              <svg
                ...
                style={{"rotate": "180deg"}}
                onClick={(e) =>
                  showingCategoryList ? showCategoryList(e.currentTarget, false) : showCategoryList(e.currentTarget, true)
                }
              >
      ...
      <div className={`filter-button basis-1/2 bg-white border-x`}> 
        <div className="filter-button__content flex flex-column py-2 px-4">
          ...
          <div className="2nd_content flex flex-row justify-between">
            <p className="extra mb-0 select-none	">{typeSelected ||"Tots els tipus"}</p>
            <div className="align-middle self-center h-auto">
              <svg
                width="18"
                height="10"
                ...
                xmlns="http://www.w3.org/2000/svg"
                onClick={(e) =>
                  showingTypeList ? showTypeList(e.currentTarget, false) : showTypeList(e.currentTarget, true)
                }
              >
                <path d="M1 1L9.16327 9L17 1" stroke="black" />
              </svg>
      ...
      <div className={`filter-button basis-1/2 bg-white border-x`}>
        <div className="filter-button__content flex flex-column py-2 px-4">
          ...
          <div className="2nd_content flex flex-row justify-between">
            <p className="extra mb-0 select-none	">{dateSelected ||"Totes les dates"}</p>
            <div className="align-middle self-center h-auto">
              <svg
                width="18"
                height="10"
                ...
                xmlns="http://www.w3.org/2000/svg"
                onClick={(e) =>
                  showingDateList ? showDateList(e.currentTarget, false) : showDateList(e.currentTarget, true)
                }
              >
                <path d="M1 1L9.16327 9L17 1" stroke="black" />
              </svg>
