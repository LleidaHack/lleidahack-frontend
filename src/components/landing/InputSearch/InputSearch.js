...
const InputSearch = ({placeholder, searchtype}) => {
    ...
    return (
        <div className='input-search border border-graycolor h-13 relative bg-white rounded flex flex-row'>
            <input type="text" placeholder={placeholder} className='w-full h-full border-none rounded-md p-4' />
            <button className='search-button bg-primaryLanding text-white w-32 rounded-r-md'>Cerca</button>
