    ...
    return (
        <div className="bg-white w-full h-auto px-16 flex flex-column">
            <div className="PrincipalEvent_content py-14">
                <EventCard_three image={principalImage} title={"titulo"} description={"fwefwefw"}/>
            </div>
            <div className="MultipleEvents_content py-14 flex flex-row gap-2">
                <div className="flex-1/4">
                    <EventCard_one imageSrc={principalImage} title={"Techmeeting 13/03/24"} description={"rfweefwe fwe fwef wef wef wef wef wef wef wef wef fwefw"} date={"03/06/2020"}/>
                </div>
                <div className="flex-1/4">
                    <EventCard_one imageSrc={principalImage} title={"TITULO"} description={"fwefwefw"} date={"03/06/2020"}/>
