...
const HackepsDashboard = () => {
  ...
  return (
    <div>
         <div className="header-events bg-background-patron px-16 min-h-0 bg-cover bg-no-repeat bg-center py-12 mb-10">  {/*//TODO:Cambiar el background por el banner de la hackeps */}
