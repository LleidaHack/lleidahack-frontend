...
const HackepsDashboard = () => {
  ...
  return (
    <div>
         <div className="header-events bg-background-patron px-10 min-h-0 bg-cover bg-no-repeat bg-center py-12 mb-10">  {/*//TODO:Cambiar el background por el banner de la hackeps */}
          ...
          <div className='flex flex-col px-10'>
            <div className='stats mb-16'>
                <h1 className='text-4xl '>Estadístiques</h1>
