    ...
    <div>
        ...
        <div className='mt-12 border-3 rounded-lg mx-8 flex flex-row py-16 px-16 gap-5 text-base flex-wrap'>
            <table className="w-full border-separate border-spacing-y-2  truncate 	">
                <thead>
                    <tr>
                        <th ><p className='mr-5 static text-xl'>Camp</p></th>
                        <th><p className='mr-5 static text-xl'>Dada</p></th>
                    </tr>
                </thead>
                <tbody className=''>
                {information.map((info, index) => (
                    <tr key={index}> {/*Camp buid per crear separacuió dins la tabla. Metode molt guarro xd */}
