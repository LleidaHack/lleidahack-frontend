...
//TODO: Pensa com diseñar la mostra dels grups amb els membres i la seva info.
    ...
    const participantsList = [  
        {status: 'Acepted', nom: 'Joan', mail: "nouMail@gmail.com", telefon: 666623245, edat: 23, talla: 'M', error:""},
        {status: 'Pending', nom: 'Maria', mail: "maria@gmail.com", telefon: 555123456, edat: 28, talla: 'S', error:""},
        {status: 'Rejected', nom: 'David', mail: "david@gmail.com", telefon: 666987654, edat: 32, talla: 'L', error:""},
        {status: 'Pending', nom: 'Laura', mail: "laura@gmail.com", telefon: 777654321, edat: 25, talla: 'M', error:""},
        {status: 'Acepted', nom: 'Carlos', mail: "carlos@gmail.com", telefon: 888456789, edat: 30, talla: 'XL', error:""},
        {status: 'Pending', nom: 'Ana', mail: "ana@gmail.com", telefon: 999234567, edat: 27, talla: 'S', error:""},
        {status: 'Acepted', nom: 'Pedro', mail: "pedro@gmail.com", telefon: 111345678, edat: 29, talla: 'M', error:""},
        {status: 'Pending', nom: 'Sara', mail: "sara@gmail.com", telefon: 222876543, edat: 26, talla: 'L', error:""},
        {status: 'Acepted', nom: 'Miguel', mail: "miguel@gmail.com", telefon: 333765432, edat: 31, talla: 'XL', error:""},
        {status: 'Pending', nom: 'Elena', mail: "elena@gmail.com", telefon: 444654321, edat: 24, talla: 'S', error:""},
        {status: 'Acepted', nom: 'Pablo', mail: "pablo@gmail.com", telefon: 555543216, edat: 33, talla: 'M', error:""}
    ]
    const grupsList = [
        {grup: 'Grup 1', nom:"Los Sacapuntas", maxMembers:4, desplegable:true, membres: [
            {status: 'Acepted', nom: 'Joan', mail: "nouMail@gmail.com", telefon: 666623245, edat: 23, talla: 'M', error:""},
            {status: 'Acepted', nom: 'Maria', mail: "maria@gmail.com", telefon: 555123456, edat: 28, talla: 'S', error:""},
            {status: 'Rejected', nom: 'David', mail: "david@gmail.com", telefon: 666987654, edat: 32, talla: 'L', error:""},
            {status: 'Acepted', nom: 'Laura', mail: "laura@gmail.com", telefon: 777654321, edat: 25, talla: 'M', error:""}
        ]},
        {grup: 'Grup 2', nom:"wakaWaka", maxMembers:4, desplegable:true, membres: [
            {status: 'Acepted', nom: 'Carlos', mail: "carlos@gmail.com", telefon: 888456789, edat: 30, talla: 'XL', error:""},
            {status: 'Pending', nom: 'Ana', mail: "ana@gmail.com", telefon: 999234567, edat: 27, talla: 'S', error:""},
            {status: 'Acepted', nom: 'Pedro', mail: "pedro@gmail.com", telefon: 111345678, edat: 29, talla: 'M', error:""},
        ]},
        {grup: 'Grup 3', nom:"Santo Domingo", maxMembers:4, desplegable:true, membres: [
            {status: 'Pending', nom: 'Elena', mail: "elena@gmail.com", telefon: 444654321, edat: 24, talla: 'S', error:""},
            {status: 'Acepted', nom: 'Pablo', mail: "pablo@gmail.com", telefon: 555543216, edat: 33, talla: 'M', error:""}
        ]},
        {grup: 'Grup 4', nom:"Los Sacapuntas", maxMembers:4, desplegable:true, membres: [
            {status: 'Pending', nom: 'Sara', mail: "sara@gmail.com", telefon: 222876543, edat: 26, talla: 'L', error:""},
            {status: 'Acepted', nom: 'Miguel', mail: "miguel@gmail.com", telefon: 333765432, edat: 31, talla: 'XL', error:""}
        ]}
    ]
