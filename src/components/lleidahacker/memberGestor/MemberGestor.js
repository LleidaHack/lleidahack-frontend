  ...
  return (
    <div>
      ...
      <div className='flex flex-row gap-3 mt-3 px-12'>
        ...
        <p className='text-xl font-bold text-gray-600 select-none'>Llistat de Membres</p>
      </div>
      <div className={`mt-16 border-3 rounded-lg mx-8 flex flex-row py-16 px-16 gap-5 text-base h-119 overflow-y-scroll ${visibilityOptions2[1] ? visibilityOptions2[1] : "hidden"}`}>
