      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          ...
          <input
            ...
            className="min-h-10 px-2 text-sm md:text-base"
          />
          {errors.nameEvent && (
        ...
        <div>
          ...
          <input
            type="date"
            {...register("dateStartEvent", { required: true })}
            className="min-h-10 px-2 text-sm md:text-base"
          />
          {errors.dateStartEvent && (
            <span className="text-red-600">This field is required</span>
          )}
        </div>
        <div>
          ...
          <input
            type="date"
            {...register("dateEndEvent", { required: true })}
            className="min-h-10 px-2 text-sm md:text-base"
          />
          {errors.dateEndEvent && (
            <span className="text-red-600">This field is required</span>
        ...
        <div>
          ...
          <input
            type="number"
            {...register("minParticipants", { required: true, min: 1 })}
            className="min-h-10 px-2 text-sm md:text-base"
          />
          {errors.minParticipants && (
            <span className="text-red-600">Minimum 1 participant</span>
          )}
        </div>
        <div>
        ...
        <div>
          ...
          <input
            type="number"
            {...register("minSponsors", { required: true, min: 0 })}
            className="min-h-10 px-2 text-sm md:text-base"
          />
          {errors.minSponsors && (
            <span className="text-red-600">Minimum 0 sponsors</span>
          )}
        </div>
        <div>
          ...
          <input
            type="number"
            {...register("maxSponsors", { required: true, min: 0 })}
            className="min-h-10 px-2 text-sm md:text-base"
          />
          {errors.maxSponsors && (
            <span className="text-red-600">Minimum 0 sponsors</span>
        ...
        <div>
          ...
          <input
            type="number"
            step="0.01"
            {...register("priceEvent", { required: true, min: 0 })}
            className="min-h-10 px-2 text-sm md:text-base"
          />
          {errors.priceEvent && (
            <span className="text-red-600">Minimum price is 0</span>
          )}
        </div>
      </div>

      <div className="w-full flex flex-col justify-end items-end mt-4">
        <ButtonLleidahack primary type="submit">
          Create Event
        </ButtonLleidahack>
      </div>
    </form>
