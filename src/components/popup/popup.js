    ...
    return (
      <div className="popup" style={{ display: mostrar ? 'block' : 'none' }}>
        <div className="popup-content">
                ...
                <span className="close" onClick={cerrarPopup}>&times;</span>
        ...
        */}
          ...
          <label htmlFor="email" className="blackt">Usuari</label>
          <Field 
            name="email" 
            type="text" 
            id="email" 
          ...
          <ErrorMessage name="email" component="div" className="error-message" />
            <br></br>
            <br></br>
          <label htmlFor="password" className="blackt">Contraseña</label>
          <Field 
            name="password" 
            type="password" 
            id="password" 
