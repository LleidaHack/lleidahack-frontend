...
const NavbarComponent = ({ centerContent, endContent, bgColor, textColor, logoimg, dropEndContent, showCenterContentOnlyOnDrop }) => {
  ...
  return (
    <div className={`flex flex-col `}>
      <div className={`w-full h-16 px-4 py-2 items-center`}
      ...
      >
        ...
        <div
          ...
          id="container-points">
          <div className={`flex md:justify-between items-center bg-background-patron h-full w-full md:bg-background-none`}
          ...
          >
            ...
            onClick={changeNavStatus}>
              {(!showCenterContentOnlyOnDrop || (showCenterContentOnlyOnDrop && !navDrop)) && centerContent }
            </div>
