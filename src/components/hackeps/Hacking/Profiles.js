        ...
        content: {type: "content", content:
            {
                div: <div className="text-center flex flex-row">
                    ...
                    <div className="instruccionsEntrega flex-1 text-justify	mr-28 ml-4">
                        ...
                        <ul className="mt-4">
                            <li className="flex flex-row gap-1"><span className="bg-red-300 rounded-full w-7 h-7 text-center inline-block">1</span> <p>Entra al DevPost i busca la Hackeps 2024.</p></li>
                            <li className="flex flex-row gap-1"><span className="bg-red-300 rounded-full w-7 h-7 text-center inline-block">2</span> <p>Busca Hackeps.....</p></li>
                            <li className="flex flex-row gap-1"><span className="bg-red-300 rounded-full w-7 h-7 text-center inline-block">3</span> <p>Selecciona l'enllaç del repte</p></li>
                            <li className="flex flex-row gap-1"><span className="bg-red-300 rounded-full w-7 h-7 text-center inline-block">4</span> <p>Pujal i llestos.</p></li>
                            
                        </ul>
                        <br></br>
                        <p>Si no trobes el devPost de la HackEps, pots accedir amb el nostre acces directe des de: <a href="lleidahack.dev/devpostHackeps">lleidahack.dev/devpostHackeps</a></p>
                    </div>
                </div>,
                bgColor: "#2484bc", 
                textColor: "#2484bc"
