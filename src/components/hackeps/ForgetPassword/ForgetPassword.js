        ...
        <div className="flex min-h-screen bg-loginPage ">
          ...
          <div className="flex-1 w-full flex flex-col items-center mt-36">
            ...
            <div className="w-1/3 mt-4">
              <p className="text-5xl text-white text-center">Necesites ajuda per a iniciar sessió?</p>
            </div>
            <div className="formBox w-1/3 mt-2">
              <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-3">
                <label className="text-white">
                  Introdueix el teu correu electrònic
                  <input className={`${errors.email ? 'bg-pink-100' : 'bg-white'} min-h-10 px-2 text-base mt-3 text-black`} placeholder="Correu electrònic" 
                ...
                <button type="submit" className="bg-primaryHackeps text-white rounded-lg p-2">Enviar enllaç de recuperació</button>
              </form>
            </div>
          </div>
