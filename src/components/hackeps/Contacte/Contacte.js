        ...
        <>
          ...
          <div className="flex flex-row justify-center gap-2 mx-4 ">
            ...
            <div className="  basis-1/2 justify-items-center content-center">
              ...
              <p className="text-xl mt-3">Esdeveniment organitzat per LleidaHack</p>
            ...
            <div className="basis-1/2 ">
              <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-3">
                <label>
                  Nom: 
                  <input className={`${errors.name ? 'bg-pink-100' : 'bg-white'} min-h-10 px-2 text-base`} placeholder="Nom" 
                ...
                <label>
                  Correu: 
                  <input className={`${errors.name ? 'bg-pink-100' : 'bg-white'} min-h-10 px-2 text-base`} placeholder="correu" 
                ...
                <label>
                  Títol: 
                  <input className={`${errors.name ? 'bg-pink-100' : 'bg-white'} min-h-10 px-2 text-base`} placeholder="Titol del missatge" 
                ...
                <label>
                  Missatge: 
                  <textarea className={`${errors.name ? 'bg-pink-100' : 'bg-white'} px-2 text-base`} placeholder="Indicans en que et podem ajudar." 
