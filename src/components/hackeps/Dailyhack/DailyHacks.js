...
import "src/components/hackeps/Dailyhack/DailyHacks.css";
      ...
      {!estadoPadre ? (
        <>
          ...
          <section className="informative">
            ...
            <p class="final-text secondary-background">
              {" "}
          ...
          <section className="upload white">
            <br />
            <h2 className=" secondary-background">Vols presentar el teu repositori?</h2>
