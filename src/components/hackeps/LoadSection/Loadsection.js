  ...
  return (
    <div className="w-full h-screen flex flex-col bg-primaryHackeps overflow-x-hidden ">
      ...
      <div className="w-full h-[55vh] bg-backgroundDuck bg-cover bg-center flex flex-row items-end justify-between">
        ...
        <div className="flex flex-row gap-24 transform translate-y-1/3 w-1/2 translate-x-48 z-30">
      ...
      <div className="flex justify-start absolute bottom-56 overflow-x-hidden z-10">
          <img src={ola} alt="Ola de mar" className="w-3/6 h-auto ola-movement  " />
      </div>
             
      <div className="w-full h-[45vh] bg-backgroundSea flex items-center justify-center z-30">
