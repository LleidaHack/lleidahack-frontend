...
const Team = (props) => {
    ...
    function TeamButtons() {
        const validationSchemaJoinTeam = Yup.object().shape({
            teamCode: Yup.string().required("Codi de l'equip requerit").matches(/^#[0-9]{6}$/, "El format ha de ser #XXXXXX on les Xs són números"),
          });
        ...
        <Container className="p-bg-grey text-center mt-5 m-0 p-3">
            ...
            <Row className="justify-content-center">
                <Button className="m-3 team-button team-button-fit" onClick={handleShowJoinTeam}>
                    Ja tinc un equip
                </Button>
                <Button className="m-3 team-button team-button-fit" onClick={handleShowCreateTeam}>
                    Crear l'equip
                </Button>
            </Row>
        </Container>
          ...
          >
            <Form>
              <div className="formik-field">
                <label htmlFor="teamCode" className="black-color">Codi de l'equip (#XXXXXX):</label>
                <Field type="text" id="teamCode" name="teamCode" />
                <ErrorMessage name="teamCode" component="div" className="error-message" />
              </div>
              <div className="button-submit-container">
                <Button className="team-button" type="submit">Envia</Button>
              </div>
            </Form>
          </Formik>
        </div>
        ...
        <div className="team-form-container">
          ...
          >
            <Form>
              <div className="formik-field">
                <label htmlFor="teamName" className="black-color">Nom de l'equip:</label>
                    ...
                    {members.map((member, index) => (
                            <Col className="col-3" key={index}>
                                <div className="p-3 text-center bg-white">
                                    <img className="team-member-image bg-black" src={user} alt="" />
