...
import {signupUser,getAllUsers,getUserById,updateUser,deleteUser,addUser} from "../../services/UserService";
import {signupHacker,getAllHackers,getHackerById,updateHacker,deleteHacker,addHacker,banHackerById,unbanHackerById} from "../../services/HackerService";
import {getAllHackerGroups,getHackerGroupById,updateHackerGroup,deleteHackerGroup,addHackerGroup,getHackerGroupMembers,addHackerToGroup,removeHackerFromGroup} from "../../services/HackerGroupService";
import {signupLleidaHacker,getAllLleidaHackers,getLleidaHackerById,updateLleidaHacker,deleteLleidaHacker,addLleidaHacker} from "../../services/LleidaHackerService";
import {getAllLleidaHackerGroups,getLleidaHackerGroupById,deleteLleidaHackerGroup,addLleidaHackerGroup,getLleidaHackerGroupMembers,addLleidaHackerToGroup,removeLleidaHackerFromGroup,setLleidaHackerGroupLeader} from "../../services/LleidaHackerGroupService";
import {getAllCompanies,getCompanyById,updateCompany,deleteCompany,addCompany,getCompanyUsers,addUserToCompany,removeUserFromCompany} from "../../services/CompanyService";
import {getEvents,createEvent,getEventById,updateEvent,deleteEvent,getEventParticipants,getEventSponsors,getEventGroups,addEventParticipant,deleteEventParticipant,addEventSponsor,deleteEventSponsor,addEventGroup,deleteEventGroup} from "../../services/EventService";
...
import {registerHackerToEvent,unregisterHackerToEvent,getEventStatus,hackerEatsFoodFrom} from "../../services/EventManagementService";
    ...
    const Fuctions=[
        {
            name: "user",
            left: 0,
            comentaris: "cors limitat, sense canviar el bearer salta en tots menys al getUserById",
            body:[
                {
                    body:signupUser, 
                    params:[user], 
            ...
            name: "lleidaHacker",
            left: 0,
            comentaris: "funcionen sense bearer, get lleidahacker by id no va peruqe no hi ha lleidahackers",
            body:[
                {
