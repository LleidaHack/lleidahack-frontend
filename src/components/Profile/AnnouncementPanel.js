...
function Button(props) {
  return (
    <a
      href={props.href}
      className="text-center btn rounded-0 p-bg-red text-decoration-none text-white m-auto px-3 py-2 me-xl-2 mb-2 d-block d-xl-inline"
    >
      {props.text}
    </a>
  );
        ...
        <div className="col-12 col-xl-7 m-auto p-4 p-bg-grey">
          ...
          <form className="d-inline" action="">
            ...
            <textarea
              ...
              rows="5"
              className="form-control rounded-0"
              placeholder="Explicacions del que vols parlar..."
            />
          </form>
          <hr />
