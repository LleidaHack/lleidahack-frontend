...
export async function getLleidaHackerGroupById(lleidaHacker_group_id) {
    return fetch(process.env.REACT_APP_DOMAIN+`/lleidahacker/group/${lleidaHacker_group_id}`, {
        headers: {
            'Content-Type': 'application/json',
            Authorization: 'Bearer ' + localStorage.getItem("userToken")
        }
...
export async function getLleidaHackerGroupMembers(lleidaHacker_group_id) {
    return fetch(process.env.REACT_APP_DOMAIN+`/lleidahacker/group/${lleidaHacker_group_id}/members`, {
        headers: {
            'Content-Type': 'application/json',
            Authorization: 'Bearer ' + localStorage.getItem("userToken")
        }
...
export async function addLleidaHackerToGroup(lleidaHacker_id, lleidaHacker_group_id) {
    return fetch(process.env.REACT_APP_DOMAIN+`/lleidahacker/group/${lleidaHacker_group_id}/members/${lleidaHacker_id}`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            Authorization: 'Bearer ' + localStorage.getItem("userToken")
...
export async function setLleidaHackerGroupLeader(lleidaHacker_id, lleidaHacker_group_id) {
    return fetch(process.env.REACT_APP_DOMAIN+`/lleidahacker/group/${lleidaHacker_group_id}/leader/${lleidaHacker_id}`, {
        method: 'PUT',
        headers: {
            'Content-Type': 'application/json',
            Authorization: 'Bearer ' + localStorage.getItem("userToken")
