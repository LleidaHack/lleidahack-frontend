export async function signupHacker(hacker) {
    return fetch(process.env.DOMAIN+'/hacker/signup', {
        method: 'POST',
        headers: {
...
export async function getAllHackers() {
    return fetch(process.env.DOMAIN+'/hacker/all', {
        headers: {
            'Content-Type': 'application/json',
...
export async function getHackerById(hacker_id) {
    return fetch(process.env.DOMAIN+`/hacker/${hacker_id}`, {
        headers: {
            'Content-Type': 'application/json',
            Authorization: 'Bearer ' + localStorage.getItem("userToken")
        }
...
export async function updateHacker(hacker) {
    return fetch(process.env.DOMAIN+`/hacker/${hacker.id}`, {
        method: 'PUT',
        headers: {
            'Content-Type': 'application/json',
            Authorization: 'Bearer ' + localStorage.getItem("userToken")
...
export async function addHacker(hacker) {
    return fetch(process.env.DOMAIN+'/hacker/', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            Authorization: 'Bearer ' + localStorage.getItem("userToken")
...
export async function banHackerById(hacker_id) {
    return fetch(process.env.DOMAIN+`/hacker/${hacker_id}/ban`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            Authorization: 'Bearer ' + localStorage.getItem("userToken")
...
export async function unbanHackerById(hacker_id) {
    return fetch(process.env.DOMAIN+`/hacker/${hacker_id}/unban`, {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
            Authorization: 'Bearer ' + localStorage.getItem("userToken")
